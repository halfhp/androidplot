...
public class SimpleXYSeries implements XYSeries {
    ...
    private volatile LinkedList<Number> yVals = null;
     ...
     */
    public synchronized void useImplicitXVals() {
        xVals = null;
    }
     ...
     *               For this format x values are autogenerated using values of 0 through n-1 where n is the size of the model.
     */
    public synchronized void setModel(List<? extends Number> model, ArrayFormat format) {
     ...
     * @param index
     */
    public synchronized void setX(Number value, int index) {
     ...
     * @param index
     */
    public synchronized void setY(Number value, int index) {
