...
## Releasing
See [releasing.md](releasing.md) for the release checklist: what to prepare, how the tag-driven
release workflow works, how to verify it, and the post-release steps.
